...
(function () {
    ...
    var Particle = function (parent, x, y) {
      ...
      this.ctx = parent.ctx;
      this.particleColor = "#5a2493"; // Set particle color to purple
    ...
    var ParticleNetwork = function (parent) {
      this.options = {
        ...
        netLineDistance: 200,
        netLineColor: "#5a2493", // Set line color to purple
        particleColors: ["#5a2493"] // ['#6D4E5C', '#aaa', '#FFC458' ]
      };
      this.canvas = parent.canvas;
      this.ctx = parent.ctx;
      ...
      if (this.canvas) {
        ...
        for (var i = 0; i < this.particles.length; i++) {
          for (var j = this.particles.length - 1; j > i; j--) {
            ...
            this.ctx.beginPath();
            this.ctx.strokeStyle = this.options.netLineColor; // Set line color to purple
